    ...
    <nav class="flex-1 px-3 overflow-y-auto">
      ...
      <div class="space-y-1 mb-6">
        ...
        >
          <div class="flex-shrink-0 w-4 h-4 flex items-center justify-center">
            ...
            <!-- Academic Year icon -->
            <svg v-else-if="item.icon === 'academic'" class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div class="space-y-1 mb-6">
        ...
        >
          <div class="flex-shrink-0 w-4 h-4 flex items-center justify-center">
            <!-- Academic Year icon -->
            <svg v-if="item.icon === 'academic'" class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
            </svg>
            <!-- Book icon -->
            <svg v-else-if="item.icon === 'book'" class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Class icon -->
            <svg v-else-if="item.icon === 'class'" class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const academicMenuItems = [
  { path: '/academic-years', name: 'Tahun Akademik', icon: 'academic', adminOnly: true },
  ...
  { path: '/class-dashboard', name: 'Manajemen Kelas', icon: 'class' },
