  ...
  <div :class="['bg-white shadow-lg transition-all duration-300', isCollapsed ? 'w-20' : 'w-64']">
    ...
    <nav class="px-4 space-y-6">
      ...
      <div v-if="!isCollapsed">
        <h3 class="px-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Menu Utama</h3>
      </div>
      <div class="space-y-1">
        <router-link
      ...
      <!-- Academic Menu -->
      <div v-if="!isCollapsed">
        <h3 class="px-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Akademik</h3>
      </div>
      <div class="space-y-1">
        <router-link
        ...
        >
          <div class="flex-shrink-0 w-5 h-5 flex items-center justify-center">
            <!-- Book icon -->
            <svg v-if="item.icon === 'book'" class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
