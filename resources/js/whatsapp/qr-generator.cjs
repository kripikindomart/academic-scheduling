// Import baileys-gateway
const { BaileysGateway, EVENTS } = require('@kripikindomart/baileys-gateway');
...
async function generateQR() {
    try {
        ...
        const sessionFolder = path.join(__dirname, '../../../storage/whatsapp/sessions');
