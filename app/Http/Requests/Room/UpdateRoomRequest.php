...
class UpdateRoomRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'room_code' => 'nullable|string|max:20|unique:rooms,room_code,' . $roomId,
    ...
    public function withValidator($validator)
    {
        $validator->after(function ($validator) {
            ...
            if ($this->building && $this->floor && $this->name) {
            ...
            // Validate occupancy cannot exceed capacity
            if ($this->current_occupancy && $this->capacity && $this->current_occupancy > $this->capacity) {
                $validator->errors()->add('current_occupancy', 'Current occupancy cannot exceed room capacity.');
            }
        });
    }
}