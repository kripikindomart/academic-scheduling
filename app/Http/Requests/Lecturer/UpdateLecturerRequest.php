...
class UpdateLecturerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'employee_number' => 'nullable|string|max:20|unique:lecturers,employee_number,' . $lecturerId,
            'name' => 'required|string|max:255',
            'email' => 'required|email|max:255|unique:lecturers,email,' . $lecturerId,
            ...
            'id_card_number' => 'required|string|max:50|unique:lecturers,id_card_number,' . $lecturerId,
            'passport_number' => 'nullable|string|max:50|unique:lecturers,passport_number,' . $lecturerId,
            'status' => 'nullable|in:active,inactive,on_leave,terminated,retired',
            'employment_status' => 'required|string|max:100',
            'employment_type' => 'nullable|in:permanent,contract,part_time,guest',
            ...
            'academic_load' => 'nullable|integer|min:1|max:24',
